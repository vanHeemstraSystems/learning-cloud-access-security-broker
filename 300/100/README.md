...
Initiative: **Master Cloud Access Security Broker**
...
Hence, mastering cloud access security broker has been successful if we either ```learn how to do it properly``` or we ```succeed in understanding it completely```. 
